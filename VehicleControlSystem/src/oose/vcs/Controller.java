...
public class Controller
{
	...
	public String[] vehicles = { "Boat", "Ship", "Truck", "Motorcycle", "Bus", "Car", "Bicycle", "Helicopter", "Airplane", "Tram", "Train"};
	...
	public boolean accelerate, decelerate, cruise,stop;
	public static int currentvelocity = 1;
	public static int maximumvelocity = 300;
